...
The methodology, gate table, and workflow live in `AGENTS.md` — this
file never duplicates that content. Everything below this line is
Claude-specific: the installed design-system skill kit's persona and
Request Router.
