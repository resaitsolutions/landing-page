...
3. **Design to the bar** — full spec: anatomy, variants, sizes, the 8 states, token mapping, a11y (AGENTS.md §9.9 Component Quality Bar).
...
5. **Document & ship** — add the spec file, wire it into AGENTS.md (§9.18 File Reference Map + relevant table), bump version, changelog.
...
- Maintain a single source of truth (this repo / AGENTS.md §9.3 Request Router) so consumers know where to look.
...
- Is the spec at the full quality bar and wired into AGENTS.md?
